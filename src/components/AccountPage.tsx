      ...
      if (auth.currentUser) {
        try {
          ...
          setFormData({
            ...
            servingSize: data.preferences?.servingSize || 2,
            theme: data.preferences?.theme || 'light',
            dailyCalories: data.preferences?.dailyCalories || 2000
          });
        } catch (error) {
        ...
        <div className="space-y-4">
          ...
          {userData.isPremium && (
            <div>
              ...
              {isEditing ? (
                ...
                <p className="text-gray-600">{formData.dailyCalories} calories</p>
              )}
            </div>
          )}
          ...
          <div>
            ...
            {isEditing ? (
              ...
              <p className="text-gray-600 capitalize">{formData.theme}</p>
            )}
          </div>
        </div>
